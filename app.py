...
st.set_page_config(page_title="MCP-Powered Generative AI Job Finder", layout="wide")
st.title("🚀 MCP-Powered Generative AI Job Finder")
st.markdown("Upload your resume to get a personalized career report with job recommendations from LinkedIn and Naukri.")
